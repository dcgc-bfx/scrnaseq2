...
The project focuses on comparison of Naive vs 10d Arthritis (4/group) mouse groups. The samples are named as 
-   LSK
-   LK
-   BM monocytes
-   Spleen monocytes

Two assays are present: RNA and ADT; the steps filtering, normalization and dimensionality reduction are performed per assay. Then after the clustering and UMAP step, the data from both assays is combined to get a better picture.
