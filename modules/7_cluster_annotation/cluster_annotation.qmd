...
markers_list = lapply(SeuratObject::Assays(sc), function(assay) {
  ...
  markers_filt_intermediate$all$gene = paste0(markers_filt_intermediate$all$gene, assay, "_")
  markers_filt_intermediate$up$gene = paste0(markers_filt_intermediate$up$gene, assay, "_")
  markers_filt_intermediate$down$gene = paste0(markers_filt_intermediate$down$gene, assay, "_")
...
CalloutBox("The prefix (_RNA, _ADT, or else) to the marker names signify what assay they come from.", type="note")
```
