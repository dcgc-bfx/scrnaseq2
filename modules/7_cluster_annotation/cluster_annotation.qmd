...
params:
  ...
  # Known markger genes
  file_known_markers: "known_markers.xlsx"
...
We require marker genes to be expressed in at least `r param("marker_pct") * 100`% of cells in the respective cluster, with a minimum log2 fold change of `r param("marker_log2FC")` and an adjusted p-value of at most `r param("marker_padj")`. The names of cluster markers, alongside statistical measures and additional gene annotation are written to file.
...
#| tbl-cap: "Up to top 5 markers per cluster"
