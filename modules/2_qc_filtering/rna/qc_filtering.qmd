...
chrY_vals = Seurat::PercentageFeatureSet(sc, features=chrY_features, pattern="^$")
...
# Issue: Finding orthologues via biomaRt (getLDS) seems to be bugged failed for several versions (https://github.com/Huber-group-EMBL/biomaRt/issues/61)
# Solution: Always use version 105 (https://dec2021.archive.ensembl.org)
# Note: Might not work for newer species
ensembl_version = 105
