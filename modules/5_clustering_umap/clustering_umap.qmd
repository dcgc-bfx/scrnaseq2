...
openxlsx::write.xlsx(x=vis, file=paste0(param("module_dir"), "/results/", outfile), row.names=TRUE)
...
openxlsx::write.xlsx(x=sc[["seurat_clusters"]], file=paste0(param("module_dir"), "/results/", outfile), row.names=TRUE)
