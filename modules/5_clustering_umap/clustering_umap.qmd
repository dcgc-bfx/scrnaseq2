...
cluster_resolution = param("cluster_resolution")
cluster_resolutions = c(cluster_resolution, param("cluster_resolution_test")) %>% unique() %>% sort()
dim_n = param("dim_n")
...
n = paste0(DefaultAssay(sc), "_snn_res.", cluster_resolution)
