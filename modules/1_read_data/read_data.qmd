...
for (i in seq_along(counts_lst)) {
  ...
  # Collect directories with spatial data
  # - 10x Visium: subdirectory 'spatial'
  # - 10x VisiumHD: for each bin size, there is a subdirectory 'spatial'
  # - 10x Xenium: in the same directory
  paths = purrr::map_chr(counts_lst[[i]], attr, "path")
