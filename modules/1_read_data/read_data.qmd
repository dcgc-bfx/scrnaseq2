...
sc = ScAddColours(sc, colours=list(
  orig.ident=setNames(c(zeileis_28, godsnot_102) %>% sample(size=length(levels(sc$orig.ident))), levels(sc$orig.ident)),
  sample=setNames(c(zeileis_28, godsnot_102) %>% sample(size=length(levels(sc$sample))), levels(sc$sample)),
  technology=setNames(c(zeileis_28, godsnot_102) %>% sample(size=length(levels(sc$technology))), levels(sc$technology)),
  seurat_clusters=setNames(c(godsnot_102, zeileis_28) %>% sample(size=length(c(godsnot_102, zeileis_28))), 1:length(c(godsnot_102, zeileis_28))),
