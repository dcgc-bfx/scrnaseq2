...
params:
  ...
  # For segmentation-based (i.e. non-spot/bin-based) spatial data, which type of segmentation to load: 'nuclei' or 'cell' segmentations, or just 'centroids' cell centers. 
  # When loading 'nuclei' or 'cell' segmentations, 'centroids' are loaded as well as default for plotting. 
  segmentation_type: "cell"
...
for (i in 1:nrow(datasets)) {
  ...
  # Default assay for image
  image_dir = dirname(path)
  default_image_assay = default_assay
  image_key = paste0("image", ".", orig_ident)
  
  # For segmentation-based (non-spot/bin-based), whether to load cell or nuclei segmentations
  segmentation_type = param("segmentation_type")
...
Finally, we calculate some basic statistics such as the percentage of counts in the top n features.
