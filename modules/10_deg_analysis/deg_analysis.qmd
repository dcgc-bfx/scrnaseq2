...
params:
  ...
  #
  # deseq2_design: For DESeq2 tests, specify a design formula for testing. (default: null). 
  #                Replaces the 'covariate' setting. Include the term 'condition_groups' for the condition.
  #                For 'DESeq2LRT', specify a design formula for the full model and the reduced model.
  # deseq2_args: For DESeq2 tests, additional arguments (format key: value) passed to the DESeq2 results function (default: null)
  # 
  ...
  contrasts:
      value:
          ...
          - Comparison3:
                ...
                test: "DESeq2"
                deseq2_design: "~ condition_groups + seurat_clusters"
