...
if (normalisation_method == "lognorm") {
  ...
  MessageBox("We have used the log normalisation of Seurat.")
  ...
  MessageBox("We have used the scran normalization.")
  ...
  MessageBox("We have used the SCTransform normalization.")
}
...
MessageBox("We have used the {feature_selection_method} method to select {num_variable_features} variable features.")
```
...
# Print a message
MessageBox("The following variables were regressed out during scaling of the data: {vars_to_regress*}.")
```
...
# - 'data' appears to be neccessary for downstream analysis
# - 'counts' is not neccessary for downstream analysis
if (normalisation_method == "SCT") {
