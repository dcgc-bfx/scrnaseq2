...
plist = Seurat::DimHeatmap(sc, 
                           reduction=DefaultReduct(sc, assay=assay),
                           dims=1:min(min(5, dim_n_compute), ncells), 
