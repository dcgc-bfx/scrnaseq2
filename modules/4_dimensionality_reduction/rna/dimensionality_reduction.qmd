...
params:
  ...
  # The following methods are available: null (just merge), CCAIntegration, RPCAIntegration, HarmonyIntegration, FastMNNIntegration, scVIIntegration (does not work).
  integration_methods:
  - "CCAIntegration"
  - "RPCAIntegration"
  - "HarmonyIntegration"
