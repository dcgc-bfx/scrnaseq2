...
#' Read delimited metadata.
#'
#' @description Reads metadata from a delimited text file and uses the first column as row names.
#'
#' @param csv_file Path to a delimited text file.
...
#' Read Excel metadata.
#'
#' @description Reads metadata from an Excel sheet and uses the first column as row names.
#'
#' @param excel_file Path to an Excel file.
#' @param sheet Excel sheet number or name. Default is 1.
#' @return A metadata data frame.
#'
#' @note AI-assisted documentation.
...
#' Read RDS metadata.
#'
#' @description Reads metadata from an RDS file while preserving R data types such as factors.
#'
#' @param rds_file Path to an RDS file.
#' @return A metadata data frame.
#'
#' @note AI-assisted documentation.
...
#' Read metadata by file type.
#'
#' @description Dispatches metadata loading to the correct reader for text, Excel or RDS files.
#'
...
#' Read a datasets table.
#'
#' @description Reads and validates the workflow datasets table.
#'
#' @param file Input or output file path.
#' @return A data frame describing datasets and input paths.
#'
#' @note AI-assisted documentation.
...
#' Read counts from a delimited file.
#'
#' @description Reads count data from a delimited text file with optional transposition and barcode suffix stripping.
#'
#' @param csv_file Path to a delimited text file.
#' @param transpose Whether to transpose the count matrix after reading. Default is FALSE.
...
#' Read Matrix Market counts.
#'
#' @description Reads Matrix Market count data together with barcode and feature annotation files.
#'
#' @param mtx_directory Directory containing Matrix Market files.
#' @param mtx_file_name Matrix Market file name. Default is "matrix.mtx.gz".
#' @param transpose Whether to transpose the count matrix after reading. Default is FALSE.
#' @param barcodes_file_name Barcode file name. Default is "barcodes.tsv.gz".
#' @param barcodes_column_names Whether the barcode file contains column names. Default is FALSE.
#' @param features_file_name Feature file name. Default is "features.tsv.gz".
#' @param features_column_names Whether the feature file contains column names. Default is FALSE.
#' @param feature_type_column Column containing feature type labels. Default is NULL.
#' @param delim Delimiter used by text files. Default is "\t".
#' @param strip_suffix Optional barcode suffix to remove. Default is NULL.
#' @return A list of sparse count matrices by assay or feature type.
#'
#' @note AI-assisted documentation.
...
#' Read counts from h5ad.
#'
#' @description Reads count data and metadata from an AnnData HDF5 file.
#'
#' @param h5ad_file Path to an h5ad file.
#' @param strip_suffix Optional barcode suffix to remove. Default is NULL.
#' @return A list containing count matrices and metadata.
#'
#' @note AI-assisted documentation.
...
#' Read Smart-seq counts.
#'
#' @description Reads Smart-seq count matrices for configured assays.
#'
#' @param path Input or output path.
#' @param assays Assays to read, write or process.
#' @param version Input format version.
#' @param transpose Whether to transpose the count matrix after reading. Default is FALSE.
#' @return A named list of count matrices.
#'
#' @note AI-assisted documentation.
...
#' Read 10x Matrix Market counts.
#'
#' @description Reads 10x Genomics Matrix Market output and maps feature types to assay names.
#'
#' @param mtx_directory Directory containing Matrix Market files.
#' @param strip_suffix Optional barcode suffix to remove. Default is NULL.
...
#' Read 10x HDF5 counts.
#'
#' @description Reads 10x Genomics HDF5 feature-barcode matrices and maps feature types to assay names.
#'
#' @param h5_file Path to a 10x HDF5 file.
#' @param strip_suffix Optional barcode suffix to remove. Default is NULL.
#' @return A named list of sparse count matrices.
#'
#' @note AI-assisted documentation.
...
#' Read 10x counts.
#'
#' @description Reads 10x counts from either HDF5 or Matrix Market output.
#'
#' @param path Input or output path.
...
#'
#' @description Reads 10x Visium count data and returns assay-specific count matrices.
#'
#' @param path Input or output path.
#' @param assays Assays to read, write or process. Default is NULL.
#' @param strip_suffix Optional barcode suffix to remove. Default is NULL.
...
#' Read 10x Visium HD counts.
#'
#' @description Reads binned Visium HD count data for one or more bin sizes.
#'
#' @param path Input or output path.
#' @param assays Assays to read, write or process. Default is NULL.
#' @param strip_suffix Optional barcode suffix to remove. Default is NULL.
...
#'
#' @description Reads Xenium count data and returns assay-specific count matrices.
#'
#' @param path Input or output path.
#' @param assays Assays to read, write or process. Default is NULL.
#' @param strip_suffix Optional barcode suffix to remove. Default is NULL.
...
#' Read Parse Biosciences Matrix Market counts.
#'
#' @description Reads Parse Biosciences Matrix Market output and maps feature types to assay names.
#'
#' @param mtx_directory Directory containing Matrix Market files.
#' @param strip_suffix Optional barcode suffix to remove. Default is NULL.
#' @return A named list of sparse count matrices.
...
#' Read Parse Biosciences h5ad counts.
#'
#' @description Reads Parse Biosciences counts from an AnnData HDF5 file.
#'
#' @param h5ad_file Path to an h5ad file.
#' @param strip_suffix Optional barcode suffix to remove. Default is NULL.
#' @return A named list of sparse count matrices.
...
#'
#' @description Reads Parse Biosciences counts from Matrix Market or h5ad input.
#'
#' @param path Input or output path.
#' @param assays Assays to read, write or process.
#' @param strip_suffix Optional barcode suffix to remove. Default is NULL.
...
#' Read Scale Bio Matrix Market counts.
#'
#' @description Reads Scale Bio Matrix Market output and maps feature types to assay names.
#'
#' @param mtx_directory Directory containing Matrix Market files.
#' @param strip_suffix Optional barcode suffix to remove. Default is NULL.
#' @return A named list of sparse count matrices.
...
#'
#' @description Reads Scale Bio count data from supported input paths.
#'
#' @param path Input or output path.
#' @param assays Assays to read, write or process.
#' @param strip_suffix Optional barcode suffix to remove. Default is NULL.
...
#' Read count data by technology.
#'
#' @description Dispatches count loading for Smart-seq, 10x, Parse Biosciences and Scale Bio inputs.
#'
#' @param path Input or output path.
...
#' Write counts to a matrix directory.
#'
#' @description Writes a count matrix to a directory containing Matrix Market, barcode and feature files.
#'
...
#'
#' @description Writes a count matrix and optional barcode or feature metadata as Matrix Market files.
#'
#' @param counts Count matrix to write.
#' @param path Input or output path.
#' @param overwrite Whether to overwrite existing output. Default is FALSE.
#' @param barcode_data Optional barcode metadata written with counts. Default is NULL.
#' @param feature_data Optional feature metadata written with counts. Default is NULL.
...
#'
#' @description Reads Visium spatial image data and optionally filters, orders and renames barcodes.
#'
...
#' @param segmentation_type Which type of segmentation to read in: nuclei (centroids) or cells
...
ReadImage_10xVisium = function(image_dir, barcodes=NULL, segmentation_type="centroids") {
  ...
  if (!is_segmented) {
      ...
      # Compute cell and nuclei areas from 2x2um bins
...
#'
#' @description Converts cell boundary coordinates into a Seurat segmentation object.
#'
#' @param coords Coordinate table used to create segmentations.
...
#'
#' @description Reads Xenium centroid, segmentation and molecule coordinate data into a Seurat field-of-view object.
#'
#' @param image_dir Directory containing spatial image or coordinate data.
#' @param barcodes Optional barcode vector used to filter, order or rename cells. Default is NULL.
...
#'
#' @note AI-assisted documentation.
ReadImage_10xXenium = function(image_dir, barcodes=NULL, coordinate_type="centroids") {
  # Checks
  assertthat::is.readable(image_dir)
...
#' Read spatial image data by technology.
#'
#' @description Dispatches spatial image loading for Visium, Visium HD and Xenium data.
#'
#' @param image_dir Directory containing spatial image or coordinate data.
#' @param technology Sequencing or spatial technology name.
...
#'
#' @note AI-assisted documentation.
ReadImage = function(image_dir, technology, assay, barcodes, coordinate_type="centroids") {
  library(magrittr)
...
#' Read Smart-seq metrics.
#'
#' @description Reads Smart-seq metrics from a metrics file.
#'
#' @param metrics_file Path to a metrics file.
#' @return A data frame with run metrics.
#'
#' @note AI-assisted documentation.
...
#' Read 10x metrics.
#'
#' @description Reads 10x metrics summary data.
#'
#' @param metrics_file Path to a metrics file.
#' @return A data frame with run metrics.
#'
...
#' Read Parse Biosciences metrics.
#'
#' @description Reads Parse Biosciences metrics data.
#'
#' @param metrics_file Path to a metrics file.
#' @return A data frame with run metrics.
#'
...
#' Read Scale Bio metrics.
#'
#' @description Reads Scale Bio metrics data.
#'
#' @param metrics_file Path to a metrics file.
#' @return A data frame with run metrics.
#'
...
#' Read metrics by technology.
#'
#' @description Dispatches metrics loading for supported sequencing technologies.
#'
#' @param metrics_file Path to a metrics file.
#' @param technology Sequencing or spatial technology name.
#' @return A data frame with technology-specific metrics.
#'
#' @note AI-assisted documentation.
...
#'
#' @description Extracts plate, row and column information from cell names using a regular expression.
#'
#' @param cell_names Cell names to parse.
#' @param pattern Regular expression used for parsing. Default is '_(\\d+)_([A-Z])(\\d+)$'.
#' @return A data frame with parsed plate metadata.
#'
#' @note AI-assisted documentation.
...
#' Save a Seurat object with on-disk data.
#'
#' @description Saves a Seurat object and optionally copies or reuses associated on-disk matrix layers.
#'
#' @param sc Seurat object.
#' @param outdir Output directory.
#' @param write_disk_data Whether to copy on-disk assay data. Default is TRUE.
#' @param relative_paths Whether stored on-disk paths should be relative. Default is FALSE.
#' @param compress Whether to compress the saved RDS file. Default is FALSE.
#' @return Writes the Seurat object and layer data to disk; no explicit return value.
#'
#' @note AI-assisted documentation.
...
#' Copy on-disk matrix directories.
#'
#' @description Copies on-disk assay layers to a new directory and updates their paths in a Seurat object.
#'
#' @param sc Seurat object.
#' @param dir Target directory.
#' @param assays Assays to read, write or process. Default is NULL.
#' @param layer Assay layer to use. Default is NULL.
#' @param update_tool_saveseuratrds Whether to update SaveSeuratRds tool metadata. Default is FALSE.
#' @return A Seurat object with updated on-disk layer paths.
#'
#' @note AI-assisted documentation.
...
#' Export a Loupe file.
#'
#' @description Exports counts, categorical metadata and embeddings from a Seurat object to a Loupe file.
#'
#' @param sc Seurat object.
...
#' @param embeddings Dimensionality reductions or embeddings to include. Default is NULL.
#' @param barcodes Optional barcode vector used to filter, order or rename cells. Default is NULL.
#' @param output_dir Output directory. Default is ".".
#' @param output_name Output file name. Default is "cloupe.cloupe".
#' @return The status returned by loupeR when creating the Loupe file.
#'
#' @note AI-assisted documentation.
...
#' Export Xenium Explorer categories.
#'
#' @description Exports categorical Seurat metadata to a Xenium Explorer analysis archive.
#'
#' @param sc Seurat object.
#' @param assay Assay to use; NULL uses the default assay when supported. Default is NULL.
#' @param categories Categorical metadata columns to include. Default is NULL.
